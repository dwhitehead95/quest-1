# PLEASE READ:
Thank you for taking the time to review my quest! I implemented a basic containerized infrastructure to host the node.js app. I was unable to deploy the docker container running the app to ECR to provide a screenshot due to not having the ability to setup awscli creds. I had to hard code the creds from my personal account into the tf code just to deploy the infrastucture as my current company controls my config file containing my aws creds and I do not have a functioning personal laptop. If you run the terraform code you will find it sets up the requested infrastucture. Were I to have more time and a personal lapptop I would have organized my TF code into seperal files for scaling, added cloudwatch, SQS, and SNS infrastructure for monitoring, a CircleCI or Github actions integration for container deployment to ECR, and an ACM certificate allowing me to setup TLS encryption on the ALB listener. I will discuss how I would do all this in further discussions if you find this minimal work suitable. Thank you again for your time.
